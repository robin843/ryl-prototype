  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container max-w-3xl py-8 px-4">
        ...
        <h1 className="text-3xl font-bold mb-8">Nutzungsbedingungen für Ryl Producer</h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">2. Voraussetzungen</h2>
            <p className="text-muted-foreground">
              Um als Ryl Producer tätig zu werden, musst du:
            </p>
            <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
              <li>Mindestens 18 Jahre alt sein</li>
              <li>Über die erforderlichen Rechte an den von dir erstellten Inhalten verfügen</li>
              <li>Die Berechtigung haben, die von dir beworbenen Produkte zu vermarkten</li>
              <li>Wahrheitsgemäße Angaben in deiner Bewerbung machen</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3">3. Inhaltsrichtlinien</h2>
            <p className="text-muted-foreground">
              Als Producer verpflichtest du dich, nur Inhalte zu erstellen, die:
            </p>
            <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
              <li>Keine Urheberrechte Dritter verletzen</li>
              <li>Keine irreführende Werbung oder falsche Produktversprechen enthalten</li>
              <li>Keine diskriminierenden, beleidigenden oder illegalen Inhalte beinhalten</li>
              <li>Den geltenden Werberichtlinien und Kennzeichnungspflichten entsprechen</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3">4. Shopable-Produkte</h2>
            <p className="text-muted-foreground">
              Bei der Verknüpfung von Produkten in deinen Videos stellst du sicher, dass:
            </p>
            <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
              <li>Alle Produktinformationen korrekt und aktuell sind</li>
              <li>Die Preisangaben der Realität entsprechen</li>
              <li>Du berechtigt bist, diese Produkte zu bewerben</li>
              <li>Die Produkte legal erhältlich und versendbar sind</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">6. Kündigung und Sperrung</h2>
            <p className="text-muted-foreground">
