  ...
  const shareOptions = [
    {
      ...
      color: "bg-[#25D366]",
      onClick: () => { shareToWhatsApp(shareData); onClose(); },
    },
    {
      name: "Telegram",
      icon: <Send className="w-6 h-6" />,
      color: "bg-[#0088cc]",
      onClick: () => { shareToTelegram(shareData); onClose(); },
    },
    {
      name: "X",
      icon: (
      ...
      onClick: () => { shareToTwitter(shareData); onClose(); },
    },
    {
      name: "Facebook",
      icon: (
      ...
      color: "bg-[#1877F2]",
      onClick: () => { shareToFacebook(shareData); onClose(); },
    },
    {
      name: "E-Mail",
    ...
    <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DrawerContent className="bg-background">
        <DrawerHeader className="text-center pb-2">
          <DrawerTitle className="text-lg">Teilen</DrawerTitle>
        </DrawerHeader>
